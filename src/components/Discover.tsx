  ...
  return (
    <section id="home" className="flex flex-col md:flex-row sm:py-16 py-6">
       <div className="flex w-full items-end justify-between relative">
            ...
            <div className="absolute z-[1] w-[955.72px] h-[100%] rounded-[90%] top-10 right-0 first__gradient" />
            <div className="absolute z-[1] w-[517.14px] h-[60%] rounded-3xl second__gradient top-24 left-12" />
            <div className="absolute z-[0] w-[621.96px] h-[60%] rounded-3xl first__gradient top-36 left-2" />
            <div className="absolute z-[0] w-[632.45px] h-[300px] rounded-xl third__gradient -top-20 -right-24" />
        </div>
